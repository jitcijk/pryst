...
public class JSLCreateLocalBooleanArrayNode extends JSLStatementNode {
	private final FrameSlot frameSlot;
	@Child JSLExpressionNode size;
	
	public JSLCreateLocalBooleanArrayNode(FrameSlot frameSlot, JSLExpressionNode size) {
