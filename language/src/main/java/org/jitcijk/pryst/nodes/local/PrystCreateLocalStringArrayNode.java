...
public class PrystCreateLocalStringArrayNode extends PrystStatementNode {
	private final FrameSlot frameSlot;
	@Child private PrystExpressionNode size;
	
	public PrystCreateLocalStringArrayNode(FrameSlot frameSlot, PrystExpressionNode size) {
	...
	public void executeVoid(VirtualFrame frame) {
		...
		frame.setObject(frameSlot, new String[s]);
	}
}
