...
public abstract class PrystReadLongArrayArgumentNode extends PrystTypedExpressionNode {
	private final int index;
	
	private final BranchProfile outOfBoundsTaken = BranchProfile.create();
	
	public PrystReadLongArrayArgumentNode(int index) {
		this.index = index;
	}
	...
	public PrystType getType() {
		return PrystType.ARRAY.setArrayType(PrystType.LONG);
	}
}