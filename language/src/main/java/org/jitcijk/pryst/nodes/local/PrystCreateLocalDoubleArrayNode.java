...
public class PrystCreateLocalDoubleArrayNode extends PrystStatementNode {
	private final FrameSlot frameSlot;
	@Child PrystExpressionNode size;
	
	public PrystCreateLocalDoubleArrayNode(FrameSlot frameSlot, PrystExpressionNode size) {
